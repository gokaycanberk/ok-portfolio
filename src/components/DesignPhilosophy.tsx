  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <div className="w-full px-0 mt-0">
          <div className="flex justify-end pr-10 md:pr-16 lg:pl-[calc(320px-24px)]">
            <div className="flex items-start flex-col md:flex-row">
              <div className="w-full md:w-[450px] h-[320px] relative">
                <Image
                  src="/images/img1.png"
              ...
              <div className="ml-0 md:ml-4 mt-4 md:mt-1">
                <h2 className="text-7xl md:text-8xl font-normal leading-none">
                  PEOPLE
                  <br />
                  AT HEART
        ...
        <div className="w-full mt-20 px-10 md:px-16 lg:px-24">
          <p className="text-lg mb-10 text-center font-normal">
          ...
          <p className="text-lg mb-16 text-center font-normal">
