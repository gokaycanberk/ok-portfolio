        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="relative group overflow-hidden">
            <div className="relative h-[450px] w-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                <h3 className="text-white text-xl font-medium">INTERIOR</h3>
              </div>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden">
            <div className="relative h-[450px] w-full">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                <h3 className="text-white text-xl font-medium">DIGITAL</h3>
              </div>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden">
            <div className="relative h-[450px] w-full">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                <h3 className="text-white text-xl font-medium">ART</h3>
              </div>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden">
            <div className="relative h-[450px] w-full">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                <h3 className="text-white text-xl font-medium">PHOTOGRAPHY</h3>
              </div>
            </div>
          </div>
        </div>
