      ...
      <div className="container mx-auto px-6 md:px-10 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-medium mb-2">OK Studio</h3>
            <p className="text-gray-600 max-w-xs">
              Creating innovative designs and remarkable experiences for our
              clients since 2010.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} OK Studio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
